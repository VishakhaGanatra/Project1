<template>
  <form @submit.prevent="submitdata">
    <div class="form-control " :class="{invalid: validated === 'invalid' }">
      <label for="user-name">Your Name</label>
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" @blur="validate"/>
      <p v-if="validated === 'invalid'">Enter valid name</p>
    </div>
    ...
    <div class="form-control">
    <button-name v-model="rating"></button-name>
...
export default{
  ...
  data(){
    return{
      ...
      userAge:null,
      referrer : 'google',
      interest : [], //if we have list of check box 
      how : '',
      validated : '',
      rating:null
    };
